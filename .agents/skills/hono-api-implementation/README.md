...
2. **統一エラーフォーマット**
   ...
   - `.agents/decisions/error-response-spec.md`に準拠

3. **RBAC Middleware適用**
   - 権限チェックは`requirePlatformAdmin`, `requireGroupRole`等を使用
   - `.agents/decisions/rbac-middleware-strategy.md`に準拠
...
- `.agents/decisions/node-runtime.md`
- `.agents/decisions/better-auth-pattern.md`
...
- `.agents/decisions/test-strategy.md`
