...
### 目的
- TODO管理の運用ルールを統一し、進捗可視化とアーカイブ品質を維持する。

### 必須
- 命名規則、ステータス記法、優先度分類を守る。
- 完了ファイルは条件を満たした時点で archive へ移動する。
...
### 例外
- 実装不能タスクは理由を記録したうえで廃止または保留とする。

### 参照
- [General Rules](./general-rules.md)
- [Skills: todo-list-management](../skills/todo-list-management/SKILL.md)
...
- [Decision: Node Runtime](.agents/decisions/node-runtime.md)
```
...
- **Skill**: `.agents/skills/todo-list-management/SKILL.md`
- **Agent Instructions**: `.agents/skills/todo-list-management/AGENTS.md`
